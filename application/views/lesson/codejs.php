<script type="text/javascript">
            $(document).ready(function() {
                ...
                t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "lesson/json", "type": "POST"},
                    columns: [
                         {
                            "data": "idlesson",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "idlesson",
                            "orderable": false
                        },{"data": "idlesson"},{"data": "period_id"},{"data": "lesson_nick"},{"data": "name_lesson"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
           ...
           $(document).on('submit', '#form', function(event) {
            ...
            function edit_data(id){
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(data) {
                            $("#ModalaForm").modal("show");$("[name='idlesson']").val(data.idlesson);
$("[name='period_id']").val(data.period_id);
$("[name='lesson_nick']").val(data.lesson_nick);
$("[name='name_lesson']").val(data.name_lesson);
                            $('#action').val("Edit");
                            $('#actions').val("Edit");
                    }
                });
            ...
            function clear_data(){
                ...
                $("#btn_simpan").text("Simpan");
                        $("[name='idlesson']").val("");
$("[name='period_id']").val("");
$("[name='lesson_nick']").val("");
$("[name='name_lesson']").val("");
