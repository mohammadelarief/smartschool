<script type="text/javascript">
            $(document).ready(function() {
                ...
                t = $("#mytable").DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "cfg_timetable/json", "type": "POST"},
                    columns: [
                         {
                            "data": "id",
                            "orderable": false,
                        ...
                        },
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "idtimetable"},{"data": "period_id"},{"data": "semester_id"},{"data": "keterangan"},{"data": "status"},
                        {
                            "data" : "action",
                            "orderable": false,
                            "className" : "text-center"
                ...
                $('#form')[0].reset();
                $('.modal-title').text("Tambah cfg_timetable");
                $('#action').val("Add");
                $('#actions').val("Add");
                });
            });
