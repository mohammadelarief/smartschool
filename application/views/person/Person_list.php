  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Daftar Person</h3>
        ...
        <form id="myform" method="post" onsubmit="return false">
          ...
          <div class="row" style="margin-bottom: 10px">
            <div class="col-xs-12 col-md-4">
              <a href="#" id="add_button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ModalaForm"><span class="fa fa-plus"></span> Create</a>
            </div>
