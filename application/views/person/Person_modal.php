    ...
    <div class="modal-dialog modal-xl" style="margin: 15px;width:auto">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Import Person</h3>
            </div>
            <div class="modal-body">
                <a href="<?php echo base_url("assets/templates/import_person.xlsx"); ?>" id="import_button" class="btn btn-sm btn-info" download><span class="fas fa-cloud-download-alt"></span> Download Template</a>
                <br>
                <br>
